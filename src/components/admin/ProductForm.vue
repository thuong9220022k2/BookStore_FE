<template>
    <Form @submit="submitProduct" :validation-schema="productFormSchema" enctype="multipart/form-data">
        ...
        <div v-if="imagePreview === null && productLocal.image">
            <img :src="productLocal.image" alt="Product Image" style="max-width: 20%;" />
        </div>
        <div class="form-group">
    ...
    setup(props, context) {
        const productFormSchema = yup.object().shape({
            ...
            description: yup
                ...
                .max(1000, "Mô tả sản phẩm có nhiều nhất 500 ký tự."),
            author: yup
                .string()
                .required("Tác giả sản phẩm phải có giá trị.")
                .min(2, "Tác giả sản phẩm phải ít nhất 2 ký tự.")
                .max(50, "Tác giả sản phẩm có nhiều nhất 50 ký tự."),
            price: yup
                .number()
