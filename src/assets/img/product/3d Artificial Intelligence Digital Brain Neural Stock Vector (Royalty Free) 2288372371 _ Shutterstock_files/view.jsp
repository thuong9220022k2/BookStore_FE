...
if (typeof usi_js === 'undefined') {
	usi_js = {
		campaign: {
			id: '12317939063775083703315',
			site_id: 51477,
			original_site_id: 51477,
			config_id: 119607,
			company_id: 5698,
			key: 'desktop_english',
			link: '',
			deep_link: 'https://shutterstock.7eer.net/c/16669/42913/1305?sharedid=10EvergreenGIF&url=',
			domains: '',
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/Shutterstock-TT-4-24-dsktp-blank.mp4",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
		...
		place_div:function() {
			...
			try {
				if (document.getElementById("usi_display") == null && document.getElementsByTagName("body")[0]) {
					...
					// These values are site pointers to change the affiliate link for the stuff we are overriding with 50031
if(usi_js.campaign.site_id == '50531') {
  // AI pages version A
 	usi_js.campaign.deep_link = 'https://shutterstock.7eer.net/c/16669/42913/1305?sharedid=GenAI-Generic&url=';
}
else if(usi_js.campaign.site_id == '50533') {
  // AI pages version B
	usi_js.campaign.deep_link = 'https://shutterstock.7eer.net/c/16669/42913/1305?sharedid=GenAI-AISpecific&url=';
}
else if(usi_js.campaign.site_id == '50539') {
  // Creative Flow Pages 
	usi_js.campaign.deep_link = 'https://shutterstock.7eer.net/c/16669/1468589/1305?sharedid=GIF&url=';
}
