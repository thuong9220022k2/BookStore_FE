				...
				if (!usi_app.suppress_page) {
					...
					if ((usi_app.get_user_status("user").status == "guest" || usi_app.get_user_status("user").isActive == "false") && ((/.shutterstock.com\/image-generated|.shutterstock.com\/ai-image-generator|.shutterstock.com\/generate|.shutterstock.com\/search\?image_type=generated/i).test(location.href) || checkout_ai_eligible) && (language_key == "_english")) {
						...
						if (Math.random() > .5) {
							...
							return usi_commons.load_view("yaPsbsLzeZDz4idOKY3ELDW", "50531", usi_commons.device + language_key); // Points to generic 10% 50031
							...
							return usi_commons.load_view("3auG6TdnQdWQFI3qrKzOXe5", "50533", usi_commons.device + language_key);
						}
					}
					if (usi_app.is_creative_flow_page) {
						...
						return usi_commons.load_view("N2mI8Ru0UBmN0PsXrXa3MSV", "50539", key);
					}
					if (usi_app.is_image_page || usi_app.is_image_in_cart) {
							...
							if (usi_app.messaging && usi_app.messaging.header1) {
								var split = Math.random();
									...
									if (split > 0.5) {
										...
										usi_commons.log('[usi] ' + param2 + ' - Images - Generic 10% Off Promo - [Current Design] - [language key: ' + language_key + ']');
										usi_commons.load_view(param1, param2, usi_commons.device + language_key);
									} else {
										// Animated Designs
										if ((usi_app.is_cart_page) || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "ziuKBX8BrD5aXev6VAgkVb8", param2 = "51479";
										else param1 = "NX00hPYDZUJpPjxWPUQpHO9", param2 = "51477";

									usi_commons.log('[usi] ' + param2 + ' - Images - Generic 10% Off Promo [Animated Design] - [language key: ' + language_key + ']');
									usi_commons.load_view(param1, param2, usi_commons.device + language_key);
								}
							}
						}
						...
						if (split > 0.5) {
							...
							if (usi_app.messaging && usi_app.messaging.header1) {
								usi_commons.log('[usi] ' + param2 + ' - Videos - Generic 10% Off Promo [Current Design] - [language key: ' + language_key + ']');
								usi_commons.load_view(param1, param2, usi_commons.device + language_key);
							}
						} else {
							// Animated Designs
							if ((usi_app.is_cart_page)  || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "Spz84Gg6BKEn2OO5OQKcrXv", param2 = "51483";
							else param1 = "UiTIODNTfxZ2eLh2AVrjAl3", param2 = "51481";
							usi_commons.log('[usi] ' + param2 + ' - Videos - Generic 10% Off Promo [Animated Design] - [language key: ' + language_key + ']');
							usi_commons.load_view(param1, param2, usi_commons.device + language_key);
						}
						...
						if (usi_date.is_after('2099-12-31') && usi_app.check_sub_total_price(threshold) && (usi_app.is_flexable || (usi_app.is_checkout_page && checkout != null && (checkout.textContent.trim().indexOf("FLEX 10") != -1 || checkout.textContent.trim().indexOf("5 Credit Pack") != -1 || checkout.textContent.trim().indexOf("2 Credit Pack") != -1)))) {
							...
							if (split > 0.5) {
								...
								usi_app.messaging = usi_app.get_messaging(messaging);
								if (usi_app.messaging && usi_app.messaging.header1) {
									usi_commons.log('[usi] ' + param2 + ' - Music - Generic 10% Off Promo [Current Design] - [language key: ' + language_key + ']');
									usi_commons.load_view(param1, param2, usi_commons.device + language_key);
								}
							} else {
								// Animated Designs
								if ((usi_app.is_cart_page) || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "XukyG8A2RtIZaX0zUGjrMix", param2 = "51487";
								else param1 = "kPQpBOrNK96VNtX4JaqPUBb", param2 = "51485";
								usi_commons.log('[usi] ' + param2 + ' - Music - Generic 10% Off Promo [Animated Design] - [language key: ' + language_key + ']');
								usi_commons.load_view(param1, param2, usi_commons.device + language_key);
							}
					}
					}
