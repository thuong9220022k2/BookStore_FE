<template>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center">
            ...
            <div class="sidebar-brand-text mx-3">B-Store</div>
        </a>
        ...
        <li v-if="storeAdmin.isAuthenticatedAdmin || storeStaff.isAuthenticatedStaff" class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" @click="goToCategory">Quản Lý Thương Hiệu</a>
        ...
        <li v-if="storeSale.isAuthenticatedStaff || storeAdmin.isAuthenticatedAdmin" class="nav-item">
