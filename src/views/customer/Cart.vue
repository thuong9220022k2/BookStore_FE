<template>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-12 mb-2 mt-2">
                                <button class="btn btn-cart px-4 py-2" @click="$router.push({ name: 'product' })">
                                    <i class="fa-solid fa-receipt me-2"></i>Tiếp tục mua hàng
                                </button>
                                <button class="btn btn-primary px-4 py-2 ms-3"
                                    @click="$router.push({ name: 'checkout' })">
                                    <i class="fa-solid fa-receipt me-2"></i>Thanh toán ngay
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <div v-else="state.customer.cart.length < 1" class="container py-5 text-center">
        <img src="../../assets/img/cart-empty.png" class="img-fluid" alt="">
