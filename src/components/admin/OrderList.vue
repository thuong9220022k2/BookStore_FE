            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active py-3" id="nav-all" role="tabpanel"
                            aria-labelledby="nav-all-tab">
                            <table v-for="(order, index) in filteredOrders" :key="order._id"
                        ...
                        <div v-if="filteredOrders.length > 0" class="tab-pane fade py-3" id="nav-1" role="tabpanel"
                                    ...
                                    <table class="table mt-3 mb-5 shadow" cellspacing="0" v-if="order.status === 3">
                                        <thead>
                                            <tr>
                                                <th class="text-start"> {{ order.status === 0 ? "NGÀY ĐẶT HÀNG: " :
                                                    order.status === 1 ? "ĐƯỢC DUYỆT VÀO NGÀY: " : order.status === 2 ?
                                                        "BÀN GIAO CHO NHÀ VẬN CHUYỂN VÀO NGÀY: " : order.status === 3 ?
                                                            "ĐƠNHÀNG ĐÃ BỊ HỦY VÀO NGÀY: " :
                                                            "ĐƠN HÀNG ĐÃ ĐƯỢC GIAO VÀO NGÀY: " }} {{ order.created_at }}</th>
                                                <th></th>
                                                <th :style="{ color: order.status === 0 ? 'grey' : order.status === 1 ? 'hotpink' : order.status === 2 ? 'orange' : order.status === 4 ? 'green' : 'red', }"
                                                    class="text-end">
